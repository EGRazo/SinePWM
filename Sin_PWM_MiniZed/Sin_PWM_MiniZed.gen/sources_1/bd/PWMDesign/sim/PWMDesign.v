...
//Date        : Mon Sep 26 20:47:08 2022
//Host        : DESKTOP-8MVMMJV running 64-bit major release  (build 9200)
//Command     : generate_target PWMDesign.bd
//Design      : PWMDesign
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PWMDesign,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PWMDesign,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "PWMDesign.hwdef" *) 
module PWMDesign
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  assign PL_LED_G_0 = PWM_0_PL_LED_G_0;
  PWMDesign_PWM_0_5 PWM_0
       (.PL_LED_G_0(PWM_0_PL_LED_G_0),
        .clk(processing_system7_0_FCLK_CLK0));
  PWMDesign_processing_system7_0_0 processing_system7_0
